...
- 大学名・企業名・資格名などの固有名詞は、確実に実在すると断言できるものだけを書くこと。少しでも曖昧な場合は固有名詞を出さず、「〇〇系の学部を持つ国公立大学」のような一般的な表現にとどめること`;
...
【①の書き方の必須ルール】
①の職業名は、生徒がクリックしてその職業を詳細分析できるようにするため、必ず【職業:〇〇】という形式で囲んでください。〇〇には職業名のみを入れること。
