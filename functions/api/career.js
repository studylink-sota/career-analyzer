...
【④の書き方の必須ルール】
④に出てくる学部・学科名は、生徒がクリックして詳細分析できるようにするため、必ず【学部:〇〇】という形式で囲んでください。〇〇には学部学科名のみを入れ、大学名は含めないこと。複数候補があればそれぞれ別々に囲むこと。大学名はその外側に書いてください。

例：
④ 進学すべき学部・学科：【学部:工学部 情報工学科】や【学部:理学部 情報科学科】（おすすめ大学：東京大学、京都大学、東京工業大学）`;
